...
async function renderItems() {
      ...
      <div class="parent">
        ...
        <div class="drop-up-small-parent">
          <img
            ...
            alt=""
            src="https://raw.githubusercontent.com/tivakhrusheva/js-api-homework/main/assets/cart-page/dropupsmall.svg?sanitize=true"
          />

          <img
            class="drop-up-small-icon"
            alt=""
            src="https://raw.githubusercontent.com/tivakhrusheva/js-api-homework/main/assets/cart-page/dropdownsmall.svg?sanitize=true"
          />
        </div>
      </div>
    </div>
    ...
    <img class="icon-cancel" alt="" src="https://raw.githubusercontent.com/tivakhrusheva/js-api-homework/main/assets/cart-page/iconcancel.svg?sanitize=true" />`;
